...
# 网络结构与训练方法
我们网络结构的目标是学习到一个函数<a href="https://www.codecogs.com/eqnedit.php?latex=\inline&space;f:x_{1:t},a_{t}\rightarrow&space;x_{t&plus;1}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\inline&space;f:x_{1:t},a_{t}\rightarrow&space;x_{t&plus;1}" title="f:x_{1:t},a_{t}\rightarrow x_{t+1}" /></a>，其中666
# 攻击方法
## 简单对抗攻击
