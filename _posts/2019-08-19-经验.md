...
# 安装TensorFlow1.8
1. 从[TensorFlow](https://www.tensorflow.org/install/pip#%E8%BD%AF%E4%BB%B6%E5%8C%85%E4%BD%8D%E7%BD%AE)官网上寻找所需要的TensorFlow版本。需要哪个版本的环境，就在链接的版本出修改为对应版本。例如我需要的版本是Linux gpu python3.6的Tensorflow1.8，那么我需要的下载链接应该为https://storage.googleapis.com/tensorflow/linux/gpu/tensorflow-1.8.0-cp36-cp36m-linux_x86_64.whl
2. 使用scp或gitlab等方式将安装包传到服务器上。
